...
class DetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding  =  FragmentDetailFragmentBinding.inflate(LayoutInflater.from(requireContext()), container, false)

        val argument  = requireArguments()
        val article :Articles = argument.getSerializable("news") as Articles
